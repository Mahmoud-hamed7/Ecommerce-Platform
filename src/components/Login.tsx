  ...
  return (
    <>
      <div className="max-w-7xl mt-28 mx-auto">
        <h1 className=" font-bold text-4xl text-green-600 mb-8 ">
          {" "}
          Login now{" "}
        </h1>
          ...
          <form className="w-full " onSubmit={formik.handleSubmit}>
            ...
            {isLoading ? (
              ...
              <div className="flex pl-4 justify-between  items-center">
                ...
                <button
                  type="submit"
                  className="    text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 focus:outline-none focus:border-green-500 shadow-sm font-medium rounded-lg text-sm px-4 py-2.5 transition-colors"
                >
                  Login
                </button>
                <span className="">
                  {" "}
                  <Link to={"/register"}>
                    you dont have account reisster nom{" "}
                  </Link>
                </span>
              </div>
            )}
